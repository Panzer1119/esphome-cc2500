...
void CC2500Component::setup() {
    ...
    this->write_reg_(REG_IOCFG0, VAL_IOCFG0_DEFAULT);
    this->write_reg_(REG_PKTLEN, VAL_PKTLEN_DEFAULT);
    ...
    this->write_reg_(REG_FSCAL3, VAL_FSCAL3_DEFAULT);
    this->write_reg_(REG_FSCAL2, VAL_FSCAL2_DEFAULT);
    this->write_reg_(REG_FSCAL1, VAL_FSCAL1_DEFAULT);
    this->write_reg_(REG_FSCAL0, VAL_FSCAL0_DEFAULT);
    this->write_reg_(REG_RCCTRL1, VAL_RCCTRL1_DEFAULT);
    this->write_reg_(REG_RCCTRL0, VAL_RCCTRL0_DEFAULT);
    this->write_reg_(REG_FSTEST, VAL_FSTEST_DEFAULT);
...
uint8_t CC2500Component::read_reg_(uint8_t address) {
	address += 0x80;
	this->enable();
